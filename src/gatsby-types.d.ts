...
type MdxFrontmatter = {
  readonly albumArtColor: Maybe<Scalars['String']>;
  readonly audio: Maybe<ReadonlyArray<Maybe<File>>>;
  readonly featuredImage: Maybe<File>;
  readonly title: Maybe<Scalars['String']>;
};

type MdxFrontmatterFieldSelector = {
  readonly albumArtColor: InputMaybe<FieldSelectorEnum>;
  readonly audio: InputMaybe<FileFieldSelector>;
  readonly featuredImage: InputMaybe<FileFieldSelector>;
  readonly title: InputMaybe<FieldSelectorEnum>;
};

type MdxFrontmatterFilterInput = {
  readonly albumArtColor: InputMaybe<StringQueryOperatorInput>;
  readonly audio: InputMaybe<FileFilterListInput>;
  readonly featuredImage: InputMaybe<FileFilterInput>;
  readonly title: InputMaybe<StringQueryOperatorInput>;
};

type MdxFrontmatterSortInput = {
  readonly albumArtColor: InputMaybe<SortOrderEnum>;
  readonly audio: InputMaybe<FileSortInput>;
